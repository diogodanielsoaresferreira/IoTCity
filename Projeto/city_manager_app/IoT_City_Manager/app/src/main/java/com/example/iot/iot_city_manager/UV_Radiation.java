...
public class UV_Radiation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uv__radiation);
    ...
    private void dataSetup()
    {
        ...
        TableLayout temp = (TableLayout) findViewById(R.id.uv_table);
        ...
        for (int i = 0; i < sensors_data.length; i++) {
            ...
            button.setOnClickListener(new Button.OnClickListener(){
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(UV_Radiation.this, MapSensor.class);
    ...
    class PopulateData extends AsyncTask<Void, Void, Void> {
        ...
        private String url = "http://178.62.255.129/mobile/radiation/";  // Test url // 192.168.1.129:8000 // 193.136.92.216:5010
        ...
        protected void onPostExecute(Void avoid) {
            if (json_response == null) {
                ...
                try {
                    ...
                    JSONArray values = json_response.getJSONArray("uvindex");   // all values
                    ...
                    for(int i=0; i < sensors.length(); i++) {
                        ...
                        series[i] = new LineGraphSeries<>(dp);
