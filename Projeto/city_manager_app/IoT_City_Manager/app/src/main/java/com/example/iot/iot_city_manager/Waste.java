...
public class Waste extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void dataSetup()
    {
        ...
        TableLayout temp = (TableLayout) findViewById(R.id.waste_table);
        ...
        for (int i = 0; i < sensors_data.length; i++) {
            ...
            button.setOnClickListener(new Button.OnClickListener(){
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(Waste.this, MapSensor.class);
    ...
    class PopulateData extends AsyncTask<Void, Void, Void> {
        ...
        private String url = "http://178.62.255.129/mobile/waste/";  // Test url // 192.168.1.129:8000 // 193.136.92.216:5010
        ...
        protected void onPostExecute(Void avoid) {
            if (json_response == null) {
                ...
                try {
                    ...
                    JSONArray values = json_response.getJSONArray("waste_fullness");   // all values
