...
def test():
	...
	# Grant Access Rules
	access_rules = grant_access_rules("https://iot.alticelabs.com", token, ["READ", "UPDATE"], "My device can communicate with each other", origin_account_id)
	print(access_rules)
	...
	# Create subscription
	subs = create_subscription("https://iot.alticelabs.com", token, subs_name, subs_desc, subscriber_id, device_id, stream_name, "active", 10, 3600, 5, "30,45,60", "putsreq.com/5HOYK4gjxKnsroStt4lC")
	print(subs)
